...
#define THREAD_KEYS_USER 3592 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3672 /* offsetof(struct task_struct, thread.keys_kernel) */
...
#define TRAMP_VALIAS -2199050547200 /* TRAMP_VALIAS */
